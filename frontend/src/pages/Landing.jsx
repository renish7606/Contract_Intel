    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
      ...
      <section className="relative overflow-hidden pt-20 pb-28 sm:pt-28 sm:pb-36">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 blur-3xl opacity-60" />
          <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-purple-100 to-pink-100 blur-3xl opacity-40" />
        </div>
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <motion.div
            ...
            variants={fadeUp}
            custom={0}
            className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 px-4 py-1.5 rounded-full text-xs font-semibold text-blue-700 mb-6"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              ...
              >
                ...
                {i > 0 && (
                  <div className="hidden lg:block absolute -left-3 top-10 w-6 h-0.5 bg-gradient-to-r from-blue-200 to-blue-300" />
                )}

                <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 h-full hover:border-blue-200 hover:shadow-lg transition-all duration-300 group-hover:-translate-y-1">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              variants={fadeUp}
            >
              <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-3 py-1.5 rounded-full text-xs font-semibold mb-4 border border-green-100">
            ...
            <motion.div
              ...
              variants={fadeUp}
              custom={2}
              className="bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-2xl p-8"
            >
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-6">Privacy Pipeline</p>
              <div className="flex flex-col gap-3">
                {[
                  { label: 'Contract Upload', icon: '📄', color: 'bg-blue-50 border-blue-100 text-blue-700' },
                  { label: 'PII Scrubbing', icon: '🔒', color: 'bg-red-50 border-red-100 text-red-700', highlight: true },
                  { label: 'Anonymised Clause Analysis', icon: '🧠', color: 'bg-purple-50 border-purple-100 text-purple-700' },
                  { label: 'Summary & Risk Report', icon: '✅', color: 'bg-green-50 border-green-100 text-green-700' },
                ].map((step, i) => (
                  <React.Fragment key={step.label}>
                    <div className={`flex items-center gap-3 px-4 py-3 rounded-xl border ${step.color} ${step.highlight ? 'ring-2 ring-red-200' : ''}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-2xl p-8 hover:shadow-lg hover:border-blue-200 transition-all duration-300 hover:-translate-y-1"
              >
